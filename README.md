...
- 🎉 Happy to receive **Understanding and Implementing Design Thinking Certification** from TCS: [Credential Link](https://drive.google.com/file/d/1fZbCE5Y9qu2sI1kTcYvQh2D37BiMyPAJ/view?usp=drive_link) **Problem solving and SQL gold badge** from HackerRank: [Credential Link](https://www.hackerrank.com/amit1092tiwari?hr_r=1&badge=problem-solving&stars=6&level=3&social=linkedin), **Professional Data Engineering Certification** from Google: [Credential Link](https://www.credential.net/78e593ff-1e0d-4923-bd77-58f0d5d4fa75#acc.z3coduVb)  
